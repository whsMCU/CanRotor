package com.wang.canrotor.attitudeView;//package YOUR_PACKAGE_HERE;
...
public class AttitudeView extends View { //%mod  Class & constructor renamed
    ...
    public AttitudeView(Context context, AttributeSet attrs) { //%mod
        ...
        mBackgroundColor = a.getColor(R.styleable.AttitudeView_backgroundC, Color.rgb(160,82,45)); //%mod color changed to Color.TRANSPARENT
        ...
        mLineColor = a.getColor(R.styleable.AttitudeView_lineC, Color.BLACK);
        mTextColor = a.getColor(R.styleable.AttitudeView_textC, Color.BLUE);
    ...
    private void init() {
        ...
        mRollPaint.setColor(Color.WHITE);
